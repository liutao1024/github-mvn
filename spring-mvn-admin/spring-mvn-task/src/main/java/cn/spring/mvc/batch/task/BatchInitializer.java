...
import cn.spring.mvc.batch.entity.SystemBatchTimeDispathControl;
import cn.spring.mvc.batch.entity.service.SystemBatchTaskDispathControlService;
import cn.spring.mvc.batch.entity.service.SystemBatchTimeDispathControlService;
...
public class BatchInitializer{
	...
	public void initializeBatch(){
		...
		for (SystemBatchTimeDispathControl systemBatchTimeDispathControlStatusRuning : systemBatchTimeDispathControlStatusRuningList) {
			...
			String className = "cn.spring.mvc.batch.task."+triggerGroupClassName;
