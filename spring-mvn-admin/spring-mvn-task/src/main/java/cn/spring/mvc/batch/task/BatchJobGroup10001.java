package cn.spring.mvc.batch.task;
...
import cn.spring.mvc.batch.entity.SystemBatchTimeTaskDispathResult;
import cn.spring.mvc.batch.entity.service.SystemBatchTaskDispathControlService;
import cn.spring.mvc.batch.entity.service.SystemBatchTimeTaskDispathResultService;
...
//		String className = "cn.spring.mvc.global.comm.batch.task.impl.BatchTask0001";
...
// 				String jobGroupClassName = "cn.spring.mvc.global.comm.batch.task.impl." + systemBatchTaskDispathControl.getJOB_GROUP_CLASS_NAME();
...
//		JobDataMap jobDataMap = context.getJobDetail().getJobDataMap();获取不了值
		...
		for (SystemBatchTaskDispathControl systemBatchTaskDispathControl : systemBatchTaskDispathControlList) {
			String status = "";
			String message = "";
			String jobClassName = "cn.spring.mvc.batch.task.impl." + systemBatchTaskDispathControl.getJobClassName();
