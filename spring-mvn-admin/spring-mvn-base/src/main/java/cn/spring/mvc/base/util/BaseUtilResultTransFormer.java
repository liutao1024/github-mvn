...
public class BaseUtilResultTransFormer extends AliasedTupleSubsetResultTransformer {
	private static final long serialVersionUID = 1L;
	public static final BaseUtilResultTransFormer INSTANCE = new BaseUtilResultTransFormer();
	...
	public BaseUtilResultTransFormer(List<String> columns, int charCase) {
	...
	private BaseUtilResultTransFormer() {
		this.addAlias = false;
		this.filled = true;
		this.charCase = 0;
	}
